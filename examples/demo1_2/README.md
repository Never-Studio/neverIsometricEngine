...
You can download the folder and then open demo1.html or demo2.html in a browser to see the result.
demo2.html is different from demo1.html:
The code block from line 56 to 58 changes the colors of the boxes when they collide.
