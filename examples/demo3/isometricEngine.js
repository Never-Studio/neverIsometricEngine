 ...
 class IsoObject{
	...
	draw(image,offset=[0,0,0]){
		...
		if(this.displayBox){
			...
			if(this.displayImage==false){
				drawIsoShape("black",this.boxColor,[this.maxX-offset[0],this.maxY-offset[1],this.minZ-offset[2]],[this.maxX-offset[0],this.maxY-offset[1],this.maxZ-offset[2]],[this.maxX-offset[0],this.minY-offset[1],this.maxZ-offset[2]],[this.maxX-offset[0],this.minY-offset[1],this.minZ-offset[2]],[this.maxX-offset[0],this.maxY-offset[1],this.minZ-offset[2]]);
				drawIsoShape("black",this.boxColor,[this.maxX-offset[0],this.maxY-offset[1],this.minZ-offset[2]],[this.maxX-offset[0],this.maxY-offset[1],this.maxZ-offset[2]],[this.minX-offset[0],this.maxY-offset[1],this.maxZ-offset[2]],[this.minX-offset[0],this.maxY-offset[1],this.minZ-offset[2]],[this.maxX-offset[0],this.maxY-offset[1],this.minZ-offset[2]]);
				drawIsoShape("black",this.boxColor,[this.maxX-offset[0],this.maxY-offset[1],this.maxZ-offset[2]],[this.minX-offset[0],this.maxY-offset[1],this.maxZ-offset[2]],[this.minX-offset[0],this.minY-offset[1],this.maxZ-offset[2]],[this.maxX-offset[0],this.minY-offset[1],this.maxZ-offset[2]],[this.maxX-offset[0],this.maxY-offset[1],this.maxZ-offset[2]]);
			}else{
				//unteres Viereck
	...
	keyhandler(key){
		if(this.keysPressed["up"]==1){
			...
			if(this.smartMovement){
				this.keyObject.move(0,-10)
				this.keyObject.move(-10,0)
			}else{
				this.keyObject.move(-10,-10)
			}
